...
evaluates it with Leave-One-Out CV, and exports:
    - frontend/src/data/modelMetrics.json   (accuracy, confusion matrix, per-class metrics)
    - frontend/src/data/decisionTreeRules.js (JS if-else function for browser use)
"""
...
CLINICAL_J  = ROOT / "frontend" / "src" / "data" / "clinicalPatients.json"
METRICS_OUT = ROOT / "frontend" / "src" / "data" / "modelMetrics.json"
RULES_OUT   = ROOT / "frontend" / "src" / "data" / "decisionTreeRules.js"
